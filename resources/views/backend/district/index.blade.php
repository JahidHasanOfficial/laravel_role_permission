                        ...
                        <table class="min-w-full divide-y divide-gray-200 border border-gray-200">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left text-sm font-semibold text-gray-600">District Name</th>
                                    <th class="px-4 py-2 text-center text-sm font-semibold text-gray-600">Action</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200">
                                @forelse($districts as $key => $data)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 text-center space-x-2">
                                            ...
                                            <form action="{{ route('districts.destroy', $data->id) }}"
